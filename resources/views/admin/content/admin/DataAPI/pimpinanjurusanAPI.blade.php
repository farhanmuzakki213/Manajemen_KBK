...
@section('admin')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <!-- Page Heading -->
                <h5 class="card-title fw-semibold mb-4">Data API Pimpinan Jurusan</h5>
                <div class="container-fluid">
                    @if (isset($error))
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-2-kembali">
                                    <p><a href="{{ route('pimpinanjurusan') }}" class="btn btn-success"> Kembali</a></p>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="sing_row_del" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                            <tr>
                                                <td colspan="6" class="text-center text-muted">---------------------------// Data Tabel Pimpinan Jurusan DB \\---------------------------</td>
                                            </tr>
                                            @if (isset($differences_db) && !empty($differences_db))
                                                @foreach ($differences_db as $data)
                                                    <tr class="table-Light">
                                                        ...
                                                        <td>{{ $data['r_dosen']['nidn'] }}</td>
                                                        <td>{{ $data['r_jurusan']['jurusan'] }}</td>
                                                        <td>{{ $data['periode'] }}</td>
                                                        <td>{{ $data['status_pimpinan_jurusan'] }}</td>
                                                    </tr>
                                                @endforeach
                                            @else
                                                <tr>
                        ...
                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('pimpinanjurusan.storeAPI') }}" method="POST">
                                        @csrf
