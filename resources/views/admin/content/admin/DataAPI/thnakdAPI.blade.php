...
@section('admin')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <!-- Page Heading -->
                <h5 class="card-title fw-semibold mb-4">Data API Tahun Akademik</h5>
                <div class="container-fluid">
                    @if (isset($error))
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-2-kembali">
                                    <p><a href="{{ route('thnakademik') }}" class="btn btn-success"> Kembali</a></p>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="sing_row_del" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                            <tr>
                                                <td colspan="5" class="text-center text-muted">---------------------------// Data Tabel Prodi DB \\---------------------------</td>
                                            </tr>
                                            @if (isset($differences_db) && !empty($differences_db))
                                                @foreach ($differences_db as $data)
                                                    <tr class="table-Light">
                                                        <td>{{ $loop->iteration }}</td>
                                                        <td>{{ $data['kode_smt_thnakd']}}</td>
                                                        <td>{{ $data['smt_thnakd'] }}</td>
                                                        <td>@if ($data['status_smt_thnakd'] == 1)
                                                            Aktif
                                                        @else
                                                            Tidak Aktif
                                                        @endif</td>
