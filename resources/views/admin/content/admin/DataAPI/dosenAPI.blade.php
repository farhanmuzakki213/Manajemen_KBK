                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="sing_row_del" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="7" class="text-center text-muted">---------------------------// Data API \\---------------------------</td>
                                            </tr>
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="7" class="text-center text-muted">Tidak Ada Pembaharuan
                                                        data dari API.</td>
                                                </tr>
                                            @endif
                                            <tr>
                                                <td colspan="7" class="text-center text-muted">---------------------------// Data Tabel Dosen DB \\---------------------------</td>
                                            </tr>
