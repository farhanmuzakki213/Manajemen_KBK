...
@section('admin')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <!-- Page Heading -->
                <h5 class="card-title fw-semibold mb-4">Data API Dosen Mata Kuliah</h5>
                <div class="container-fluid">
                    @if (isset($error))
                                            ...
                                            @if (isset($differences_db) && !empty($differences_db))
                                                @foreach ($differences_db as $data)
                                                    <tr class="table-Light">
                                                        ...
                                                        <td>{{ $data['r_smt_thnakd']['smt_thnakd'] }}</td>
                                                        <td>
                                                        @foreach ($data['p_matkul_kbk'] as $matkulKbk)
                        ...
                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('DosenPengampuMatkul.storeAPI') }}" method="POST">
                                        @csrf
