...
@section('admin')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <!-- Page Heading -->
                <h5 class="card-title fw-semibold mb-4">Data API Jurusan</h5>
                <div class="container-fluid">
                    @if (isset($error))
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-2-kembali">
                                    <p><a href="{{ route('jurusan') }}" class="btn btn-success"> Kembali</a></p>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="sing_row_del" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="3" class="text-center text-muted">---------------------------// Data API \\---------------------------</td>
                                            </tr>
                                            ...
                                            @endif
                                            <tr>
                                                <td colspan="3" class="text-center text-muted">---------------------------// Data Tabel Jurusan DB \\---------------------------</td>
                                            </tr>
