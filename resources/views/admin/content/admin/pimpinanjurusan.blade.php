                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @foreach ($data_pimpinan_jurusan as $data)
                                            ...
                                            {{-- Modal Detail Tabel --}}
                                            <div class="modal fade" id="detail{{ $data->id_pimpinan_jurusan }}"
                                                tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-primary text-white">
                                                            <h5 class="modal-title" id="detailLabel">Detail Pimpinan Jurusan
                                                            </h5>
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <input class="form-control" id="message-text"
                                                                            value="{{ $data->status_pimpinan_jurusan == 1 ? 'Aktif' : 'Tidak Aktif' }}"
                                                                            readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
