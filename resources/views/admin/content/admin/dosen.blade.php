                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form>
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="kode_matkul" value="{{ $data->nama_dosen }}"
                                                                        readonly>
                                                                </div>
                                                                <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" id="message-text"
                                                                    value="{{ $data->status_dosen }}" readonly></input>
                                                            </div>
                                                        </div>
