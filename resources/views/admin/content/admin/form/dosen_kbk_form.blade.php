...
@section('admin')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <!-- Page Heading -->
                <h5 class="card-title fw-semibold mb-4">Tambah Data Dosen KBK </h5>
                <div class="container-fluid">
                    <!-- Form Tambah Data -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('dosen_kbk.store') }}">
                                @csrf
                                <div class="mb-3">
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="id_pengurus" name="id_dosen_kbk">
                                    @error('id_dosen_kbk')
                                        <small>{{ $message }}</small>
                                    @enderror
                                </div> --}}
                                ...
                                <div class="mb-3">
                                    <input type="hidden" class="form-control" id="id_dosen_kbk" name="id_dosen_kbk"
