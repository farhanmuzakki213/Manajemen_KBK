                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-2">
                            <div class="d-grid gap-2 d-md-block">
                                @can('admin-create JenisKbk')
                                    <a href="{{ route('jenis_kbk.create') }}" class="btn btn-primary me-md-3"><i
                                            class="bi bi-file-earmark-plus"></i> New</a>
                                @endcan
                                @can('admin-export JenisKbk')
                                    <a href="{{ route('jenis_kbk.export') }}" class="btn btn-primary me-md-3"><i
                                            class="bi bi-box-arrow-in-up"></i> Export</a>
                                @endcan
                                @can('admin-import JenisKbk')
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{ route('jenis_kbk.import') }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="kode_matkul" value="{{ $data->jenis_kbk }}"
                                                                    readonly>
