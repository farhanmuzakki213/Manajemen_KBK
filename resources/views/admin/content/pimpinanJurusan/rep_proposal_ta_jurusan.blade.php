                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="prodi"
                                                                    value="{{ optional($data->proposal_ta)->r_mahasiswa->r_prodi->prodi }}"
                                                                    readonly>
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="tanggal_penugasan" class="form-label">Tanggal
                                                                    Penugasan</label>
                                                                <input type="date" class="form-control"
                                                                    id="tanggal_penugasan"
                                                                    value="{{ isset($data['tanggal_penugasan']) ? \Illuminate\Support\Carbon::parse($data['tanggal_penugasan'])->format('Y-m-d') : '' }}"
                                                                    readonly>
                                                            </div>
