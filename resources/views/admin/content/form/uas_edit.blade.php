                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="row justify-content-end">
                                <div class="col-2">
                                    <p><a href="{{ route('soal_uas') }}" class="btn btn-success">Kembali</a></p>
                                </div>
                            </div>
                            <form method="post" action="{{ route('soal_uas.update', ['id' => $data_uas->id_rep_uas]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label for="id_rep_uas" class="form-label">ID uas</label>
                                    <input type="number" class="form-control" id="id_rep_uas" name="id_rep_uas" value="{{ $data_uas->id_rep_uas }}">
                                    @error('id_rep_uas')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="smt_thnakd" id="smt_thnakd" required>
                                        ...
                                        @foreach ($data_thnakd as $smt_thnakd)
                                            <option value="{{ $smt_thnakd->id_smt_thnakd }}" {{ $smt_thnakd->id_smt_thnakd == $data_uas->smt_thnakd_id ? 'selected' : '' }}>
