...
class DosenKBKController extends Controller
{
    ...
    public function index()
    {
        $data_dosen_kbk = DB::table('dosen_kbk')
            ...
            ->get();
        return view('admin.content.dosen_kbk', compact('data_dosen_kbk'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.content.form.dosen_kbk_form', compact('data_dosen', 'data_jenis_kbk'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.content.dosen_kbk', compact('data_dosen', 'data_jenis_kbk', 'detail_dosen_kbk'));
    }
    ...
    public function edit(Request $request, string $id)
    {
        ...
        return view('admin.content.form.dosen_kbk_edit', compact('data_dosen', 'data_jenis_kbk', 'data_dosen_kbk'));
    }
