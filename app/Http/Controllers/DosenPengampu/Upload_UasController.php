...
class Upload_UasController extends Controller
{
    ...
    public function index()
    {
        $data_uas = DB::table('rep_uas')
            ...
            ->get();
            //dd($data_uas);
        return view('admin.content.dosenPengampu.upload_uas', compact('data_uas'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.content.dosenPengampu.form.upload_uas_form', compact('data_thnakd', 'data_dosen', 'data_matkul', 'nextNumber'));
    }
    ...
    public function store(Request $request)
{
    ...
    public function show(string $id)
    {
        ...
        return view('admin.content.dosenPengampu.upload_uas', compact('data_thnakd', 'data_dosen', 'data_matkul'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.content.dosenPengampu.form.upload_uas_edit', compact('data_thnakd', 'data_dosen', 'data_matkul', 'data_uas'));
    }
