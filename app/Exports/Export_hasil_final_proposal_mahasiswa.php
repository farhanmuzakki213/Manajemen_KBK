...
class Export_hasil_final_proposal_mahasiswa implements FromCollection, WithHeadings
{
    /**
        ...
        foreach ($two_penugasan_ids as $penugasan_id) {
            ...
            if ($reviewer_satu && $reviewer_dua) {
                $merged_data[] = [
                    ...
                    'catatan_satu' => $reviewer_satu->catatan,
                    'catatan_dua' => $reviewer_dua->catatan,
    ...
    public function headings(): array
    {
        return [
            ...
            'Pembimbing Satu',
            'Pembimbing Dua',
            'Catatan Reviewer Satu',
            'Catatan Reviewer Dua',
